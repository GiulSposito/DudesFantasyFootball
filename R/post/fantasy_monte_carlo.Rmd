...
# for all teamIds from the matchup
c(matchups$awayTeam.id, matchups$homeTeam.id) 
...
"1" %>%
  map(
    ...
    .leagueId  = leagueId,
    .authToken = authToken,
    .url       = "http://api.fantasy.nfl.com/v1/league/team/roster?leagueId={.leagueId}&teamId={.teamId}&week={.week}&authToken={.authToken}&format=json"
  )  -> rosters.json

rosters.json[[1]]$leagues$matchups[[1]]$homeTeam$
