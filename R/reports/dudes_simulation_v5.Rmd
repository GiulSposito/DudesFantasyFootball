...
Game Center {data-navmenu="Overview"}
=======================
...
game_center %>% 
  ...
  geom_text(aes(y=home.pts, label=paste0("(",9-home.teamRemaining,"/9)")), color="red", vjust=-1.5, nudge_y = 4, size=2 ) +
  ...
  geom_text(aes(y=-away.pts, label=paste0("(",9-away.teamRemaining,"/9)")), color="blue", vjust=-1.5, nudge_y = -4, size=2 ) +
  # decorators
